...
//        TableDiffer(new String[]{"description"});
    ...
    public List<Map<String, Object>> getQResult(){return QResult;}
    public List<Map<String, Object>> getOtherResult(){return OtherResult;}
    public List<Map<String, Object>> getDataResult(){return DataResult;}
